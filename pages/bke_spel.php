...
<br><br>
<!-- 3*3 grid of Boxes -->
<label for="b1"></label><input type="text" id="b1" onclick=
"myfunc_3(); myfunc();" readonly>

<label for="b2"></label><input type="text" id="b2" onclick=
"myfunc_4(); myfunc();" readonly>

<label for="b3"></label><input type="text" id="b3" onclick=
"myfunc_5(); myfunc();" readonly>
<br><br>

<label for="b4"></label><input type="text" id="b4" onclick=
"myfunc_6(); myfunc();" readonly>

<label for="b5"></label><input type="text" id="b5" onclick=
"myfunc_7(); myfunc();" readonly>

<label for="b6"></label><input type="text" id="b6" onclick=
"myfunc_8(); myfunc();" readonly>
<br><br>

<label for="b7"></label><input type="text" id="b7" onclick=
"myfunc_9(); myfunc();" readonly>

<label for="b8"></label><input type="text" id="b8" onclick=
"myfunc_10();myfunc();" readonly>

<label for="b9"></label><input type="text" id="b9" onclick=
...
<footer>
    ...
    <script>
        ...
        function terugNaarMenu() {
            document.location.href = "spel-home2.php";
        }
    </script>
</footer>
