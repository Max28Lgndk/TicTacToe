...
<head>
    ...
    <script src="../js/javascript_paars.js"></script>
...
<br><br>
<!-- 3*3 grid of Boxes -->
<label for="b1"></label><input type="text" id="paars1" onclick=
"myfunc_3(); myfunc();" readonly>

<label for="b2"></label><input type="text" id="paars2" onclick=
"myfunc_4(); myfunc();" readonly>

<label for="b3"></label><input type="text" id="paars3" onclick=
"myfunc_5(); myfunc();" readonly>
<br><br>

<label for="b4"></label><input type="text" id="paars4" onclick=
"myfunc_6(); myfunc();" readonly>

<label for="b5"></label><input type="text" id="paars5" onclick=
"myfunc_7(); myfunc();" readonly>

<label for="b6"></label><input type="text" id="paars6" onclick=
"myfunc_8(); myfunc();" readonly>
<br><br>

<label for="b7"></label><input type="text" id="paars7" onclick=
"myfunc_9(); myfunc();" readonly>

<label for="b8"></label><input type="text" id="paars8" onclick=
"myfunc_10();myfunc();" readonly>

<label for="b9"></label><input type="text" id="paars9" onclick=
